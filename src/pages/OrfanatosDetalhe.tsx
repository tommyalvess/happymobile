...
interface OrphanagesDetailsRouteParms {
  id: number;
}
...
export default function OrfanatosDetalhe() {

  const route = useRoute();
  const [orphanage, setOrphanage] = useState<Orphanage>();
  const params = route.params as OrphanagesDetailsRouteParms;



  useEffect(() => {
    api.get(`ophanages/${params.id}`).then(response => {
